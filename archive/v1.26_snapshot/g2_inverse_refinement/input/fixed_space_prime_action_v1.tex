...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.21},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.21\\
...
\toprule Old & Disposition in v1.21 \\
\midrule\endfirsthead
\toprule Old & Disposition in v1.21 (continued) \\
\midrule\endhead
\bottomrule\endfoot
