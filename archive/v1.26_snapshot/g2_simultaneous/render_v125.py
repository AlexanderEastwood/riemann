...
B=Path(__file__).resolve().parent;r=B/'renders_v125';r.mkdir(exist_ok=True)
...
for i,page in enumerate(doc):
 ...
 if i+1 in [1] or any(term in page.get_text() for term in ['simultaneous complete Schur', 'joint remote Gram', '62629', 'Exponential cutoff cost', '124442', 'simultaneous even certificate']):page.get_pixmap(matrix=fitz.Matrix(1.5,1.5),alpha=False).save(str(r/f'page_{i+1:03d}.png'))
