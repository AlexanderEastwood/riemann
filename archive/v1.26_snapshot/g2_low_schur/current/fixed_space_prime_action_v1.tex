...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.20},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.20\\
...
exponentially small full operator residual. These asymptotic estimates do not by themselves identify
...
Version 1.20 proves a signed energy bound on both parity sectors
...
alternative targets; none has been shown to follow from weak G1.
...
certificate and its exact-source identification; these do not settle
the remaining uniform analytic obligations. A publication draft would need the listed inputs
...
\toprule Old & Disposition in v1.20 \\
\midrule\endfirsthead
\toprule Old & Disposition in v1.20 (continued) \\
\midrule\endhead
\bottomrule\endfoot
