...
These files are not current manuscript copies or new validation results.
Historical scripts may require their original environment. Earlier
committed manuscript versions also remain available in Git history.

The original v1.26 cumulative ZIP is now available as a [release asset](https://github.com/AlexanderEastwood/riemann/releases/tag/v1.26-evidence). The later v1.34 cumulative ZIP is still pending; this recovery does not claim to fill that remaining gap.

## Single-live-version policy

Validated updates replace `fixed_space_prime_action_v1.tex`,
`RH_G1_G2_research_log.md`, and `v1_revision_notes.md` at the root. Keep
