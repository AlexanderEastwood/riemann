...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.41},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.41\\
...
With $a=\log\lambda$, this exponential-in-$\lambda$ cutoff belongs to
the doubly exponential family in the support half-width. Zhu's
pointwise-envelope obstruction~\cite[Section 14]{Zhu2026Windows}
has that shape, for a different certificate class. Groskin
\cite{Groskin2026} quantifies the archimedean integral-cutoff cost
for finite Weil matrices and gives a cutoff-free interval factorization.
His integral cutoff is not the Fourier-mode cutoff $N$ here. These
comparisons provide context, not a universal obstruction to every
signed estimate.
...
Sections~6--7 (the ten-route coverage table, NS-4b). The surviving joint signed
...
real-zero ground transform. The primary
...
\bibitem{Groskin2026}
A. Groskin,
\emph{A finite Guinand--Weil dictionary and archimedean tail order
for the truncated Weil quadratic form},
arXiv:2607.02828v1 (2026).
\url{https://arxiv.org/abs/2607.02828v1}.
