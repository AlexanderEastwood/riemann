...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.46},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.46\\
...
numerical illustration, not a new bound. G2 and RH remain open.
