...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.38},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.38\\
...
$\lambda=4$, with exact fixed-window error $\varepsilon_4=0$. The present scalar far
...
$\mathsf W_4\succeq0$ exactly at this window. The primary
...
The directory \texttt{g2\_finite\_floor/} contains the exact protocol,
...
The full current LaTeX source is validated in draft mode; no PDF is
generated or included in this revision.
