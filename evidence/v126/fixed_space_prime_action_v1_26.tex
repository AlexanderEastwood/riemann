...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.26},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.26\\
...
Version 1.26 proves positivity of the complete Weil form at $\lambda=4$.
...
$\lambda=4$. The complete odd sign is established below, while the corresponding
...
\toprule Old & Disposition in v1.26 \\
\midrule\endfirsthead
\toprule Old & Disposition in v1.26 (continued) \\
\midrule\endhead
\bottomrule\endfoot
