...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.24},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.24\\
...
residual correction open. Parity signs sharpen the complete inverse
...
upper bounds for subsequent degrees. A better frozen finite trial
...
Version 1.24 closes the saved one-direction Schur test at
...
bounded. Proposition~\ref{prop:v121-alpha-zero} now certifies the
...
The trial-head hypothesis is now verified in the local cases just
...
\toprule Old & Disposition in v1.24 \\
\midrule\endfirsthead
\toprule Old & Disposition in v1.24 (continued) \\
\midrule\endhead
\bottomrule\endfoot
