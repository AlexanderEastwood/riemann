...
listed below. That report records the pre-integration state. The v1.41
integration retains the later main-branch diagnostics and retractions; see
the integration report below for the combined state.
...
- [Integrated research report](research-report-2026-09-21-v3.html)
- [Integrated build report](build_report_v3.json)
- [Integration preservation checks](integration_verification.json)

The broader diagnostic at `../diag_ns2_semantic_lock/`, the detailed
coverage analysis at `../diag_ns4b_coverage/`, and the NS-3/NS-6 drafts are
retained. NS-6 is not claimed complete by this integration.
