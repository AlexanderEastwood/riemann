...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.22},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.22\\
...
Version 1.22 sharpens the complete far-inverse bounds at $\lambda=4$
...
\toprule Old & Disposition in v1.22 \\
\midrule\endfirsthead
\toprule Old & Disposition in v1.22 (continued) \\
\midrule\endhead
\bottomrule\endfoot
