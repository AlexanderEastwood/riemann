...
| [ZERO-GEOMETRY](#input-zero-geometry) | Find zeta-specific zero rigidity beyond reflection symmetry | NS94; NS100 reassessment; NS101 bounded attempt; NS103 window-sensitivity diagnostic |
...
**Scope / stop:** CAE, unrestricted exact adaptive concentration, critical Clifford domination and coefficient-one localization absorption are versions of this same floor under their stated domains. Their stronger fixed-slack or channel-deletion failures do not refute the floor. This is a second genuine shared-gap family, distinct from the NB selected numerator/cost. RH implications alone do not identify their estimates.

Sources: [evidence/v151](evidence/v151) · [evidence/v152](evidence/v152) · [evidence/ns47_clifford_weil/representation.tex](evidence/ns47_clifford_weil/representation.tex) · [evidence/ns50_cae_localization/localization-v2.tex](evidence/ns50_cae_localization/localization-v2.tex).
...
**Scope / stop:** Fixed-window real-zero transforms and proximity to the first zeta zero do not supply convergence to Xi. Absolute residual/resolvent data and a polynomial positive separator do not replace the named relative inputs. Distinct from the NB cost and API.

Sources: [evidence/v152](evidence/v152) · [evidence/v140](evidence/v140) · [evidence/v143](evidence/v143).
