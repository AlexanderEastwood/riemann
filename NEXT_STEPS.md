...
| NS-17 | Integrate the NS-3/NS-6 inserts (`evidence/drafts/v141_inserts/`) into the live tex — v1.41 did NOT include them (window-position subsection, determinacy paragraph, Krein–Langer / Basor–Ehrhardt bibitems absent; only `Groskin2026` was added) — and collapse the duplicate `Zhu2026` / `Zhu2026Windows` bibitems | open | open | v1.42 with the five inserts at their quoted anchors; single Zhu bibitem; build 0/0/0 |
