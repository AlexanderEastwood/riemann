...
| NS-2 | Semantic lock: reproduce one CCM §6 numerical value (arXiv:2511.22755) from `assembly_general.py`; report value, precision, any normalization discrepancy (a discrepancy is the better outcome) | Codex (Astra; resumed review) | in-progress (v1.41 verification and scope reconciliation) | CCM §6 Figure 1 at existing lambda=3, N=120: eight published discrepancies reproduced, first 1.582329697193127e-34. Exact centering dictionary; interval eigenpair/root gates at 768/1024 bits; finite-compression scope only. |
