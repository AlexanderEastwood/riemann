...
| NS-91 | Preserve joint arithmetic cancellation by a first primitive and endpoint correction; test a uniform route beyond the finite bound | Codex, Continue on PR42 grouped lower gain | claimed | Integrate the previously blocked standalone draft with full tail and old-space cost, then test an independent uniform estimate. No finite percentages or norm-only restatement may be called a cofinal lower-gain theorem. |
