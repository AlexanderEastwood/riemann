...
| NS-92 | Derive and test a direct arithmetic upper bound on the selected true cost, retaining the signed gain condition | Codex, Continue on PR42 after NS91 | claimed | Test a complete physical or Mellin bound with explicit hypotheses; distinguish an unconditional estimate from a square-root Mobius assumption. Do not infer a cofinal gain from finite checks. |
