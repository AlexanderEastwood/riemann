...
| NS-105 | Diagnostic: spectral profile of the archived normalized even lambda=4 trial between and beyond the zeta ordinates (envelope of the transform, sign changes vs N(T), crossover ratio); pre-registered in draft PR #59 | Claude | claimed | evidence/diag_ns105_trial_spectrum/: 1024-bit grid scan with 1280-bit subset replay; predictions P1-P3 in PROPOSAL.md tested; floats-free Arb evaluation of a frozen finite trial, not a complete-ground statement; no version, G2 or RH claim |
