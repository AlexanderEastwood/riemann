...
|---|---|---|---|---|
| NS-1 | Recover the two OPEN evidence groups: v1.28 λ=5 disproof (`g2_lambda5_transfer`, `g2_block_metric`); v1.31–v1.34 concentration/closures (`g2_weighted_concentration`, `g2_schatten_no_go`, `g2_nested_commutator`, `g2_primitive_transport`) → `evidence/v128/`, `evidence/v131..134/` + manifests | Astra | blocked (partial v1.31 report recovered; archive download HTTP 502) | `evidence/MISSING.md` has no OPEN rows; the six map nodes lose their EVIDENCE MISSING flag |
