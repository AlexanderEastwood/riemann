...
| NS-5 | Certify simple-even ground of the **complete** `W_4` (CCM Thm 5.10 / CvS Thm 6.1 hypothesis) with the `prop:v117` machinery; numerically the gap is 8 orders (`evidence/diag_circle_split/`) | open | open | certificate at two precisions ⇒ `ξ̂_4` has only real zeros, unconditionally at λ=4 |
