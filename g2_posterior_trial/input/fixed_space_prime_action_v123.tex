...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.23},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.23\\
...
Version 1.23 bounds the complete mixed correlations on the saved
...
\toprule Old & Disposition in v1.23 \\
\midrule\endfirsthead
\toprule Old & Disposition in v1.23 (continued) \\
\midrule\endhead
\bottomrule\endfoot
