...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.34},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.34\\
...
The physical even-sector alternative is now sharply delimited.
