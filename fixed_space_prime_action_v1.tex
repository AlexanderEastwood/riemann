...
\usepackage{mathrsfs}
\hypersetup{pdftitle={Fixed-Space Prime Compatibility in Burnol's Sonine Quotients -- v1.36},pdfauthor={Alexander Eastwood}}
...
\large Complete working manuscript, version 1.36\\
...
the required decay.  The candidate register therefore marks the scalar
primitive route as rejected pending a genuinely new source-sensitive
transport estimate.  The live even-sector obligation remains the full
